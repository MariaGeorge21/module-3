...
public class Product {
	@Id
	@GeneratedValue//nerationtype strategy is autope is the strategy which the jpa should use or follow to generate primary key values.the default is auto that is when strategy is not specified the jpa uses auto.
